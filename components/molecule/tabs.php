...
<div>
 ...
 <?php for ($i=0; $i < $vars['loop_size']; $i++) { 
    ...
    <li role="presentation" class="<?php if($i == 0){echo 'active'; } ?>"><a href="#<?php echo $vars['tab'][$i]['slug']; ?>" aria-controls="<?php echo $vars['tab'][$i]['slug']; ?>" role="tab" data-toggle="tab"><?php echo $vars['tab'][$i]['title'] ?></a></li>
	<?php } unset($i); ?>
  </ul>
  ...
  <div class="tab-content">
    <?php for ($i=0; $i < $vars['loop_size']; $i++) {  ?>
	    <div role="tabpanel" class="tab-panel <?php if($i == 0){echo 'active'; } ?>" id="<?php echo $vars['tab'][$i]['slug']; ?>">
